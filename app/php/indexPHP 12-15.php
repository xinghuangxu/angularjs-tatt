                    ...
                    if ($tree_data_array_all[$x]->Blocked == 1) {
                        ...
                        if ($tree_data_array_all[$x]->icon == "In-Progress") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_In-Progress_Blocked.png";
                        } elseif ($tree_data_array_all[$x]->icon == "Defined") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_Defined_Blocked.png";
                        } elseif ($tree_data_array_all[$x]->icon == "Completed") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_Completed_Blocked.png";

                        } elseif ($tree_data_array_all[$x]->icon == "Accepted") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_Accepted_Blocked.png";
                        }
                    } else {

                        if ($tree_data_array_all[$x]->icon == "In-Progress") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_In-Progress.png";
                        } elseif ($tree_data_array_all[$x]->icon == "Defined") {
                            $tree_data_array_all[$x]->icon = ".assets/img/icon_Defined.png";
                        } elseif ($tree_data_array_all[$x]->icon == "Completed") {
                            $tree_data_array_all[$x]->icon =
                                ".assets/img/icon_Completed.png";
                        } elseif ($tree_data_array_all[$x]->icon == "Accepted") {
                            $tree_data_array_all[$x]->icon = ".assets/img/icon_Accepted.png";
                        }
                    }
                ...
                for($i=0;$i<count($FinalArray);$i++){
                    $FinalArrayWithObj[$i] = new stdClass();
                            ...
                            if ($FinalArrayWithObj[$i]->Blocked == 1) {
                                            ...
                                            if ($FinalArrayWithObj[$i]->icon == "In-Progress") {
                                                $FinalArrayWithObj[$i]->icon = ".assets/img/icon_In-Progress.png";
                                            } elseif ($FinalArrayWithObj[$i]->icon == "Defined") {
                                                $FinalArrayWithObj[$i]->icon = ".assets/img/icon_Defined.png";
                                            } elseif ($FinalArrayWithObj[$i]->icon == "Completed") {
                                                $FinalArrayWithObj[$i]->icon = ".assets/img/icon_Completed.png";
                                            } elseif ($FinalArrayWithObj[$i]->icon == "Accepted") {
                                                $FinalArrayWithObj[$i]->icon = ".assets/img/icon_Accepted.png";
                                            }
                                        }
                }
