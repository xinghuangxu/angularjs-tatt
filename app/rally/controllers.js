...
app.controller('myLogin', function($scope, dataService, myAuthentication, $alert) {
...
app.controller("main", function($scope, dataService, myAuthentication, $alert) {
	//Pulls in variables from factory for use
	$scope.authentication = myAuthentication;
...
app.controller("popoverCtrl", function($scope, dataService, myAuthentication, $modal, $alert, $sce) {
