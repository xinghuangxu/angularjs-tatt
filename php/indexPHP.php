                ...
                if (($releasename == "All" && $Iteration == null) || ($releasename == "All" && $Iteration == "All")){
                    ...
                    if ($FinalArrayWithObject[$i]->Blocked == 1) {
                        ...
                        if ($FinalArrayWithObject[$i]->icon == "In-Progress") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_In-Progress_Blocked.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Defined") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Defined_Blocked.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Completed") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Completed_Blocked.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Accepted") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Accepted_Blocked.png";
                        }
                    } else {
                        if ($FinalArrayWithObject[$i]->icon == "In-Progress") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_In-Progress.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Defined") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Defined.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Completed") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Completed.png";
                        } elseif ($FinalArrayWithObject[$i]->icon == "Accepted") {
                            $FinalArrayWithObject[$i]->icon = "./lib/jstree/themes/default/icon_Accepted.png";
                        }
                    }
